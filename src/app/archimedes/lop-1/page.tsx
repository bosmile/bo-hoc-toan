...
const archimedesModules = [
  { id: 1, title: "CĐ1: Biểu thức 3 số", query: "A ± B ± C = D", link: "/archimedes/lop-1/chuyen-de-1", desc: "Tùy chỉnh phạm vi, vị trí ẩn số, chỉ định phép cộng/trừ/trộn." },
  { id: 2, title: "CĐ2: Phép nhân căn bản", query: "A x B = C", link: "/archimedes/lop-1/chuyen-de-2", desc: "Chọn bảng cửu chương, xáo trộn, tìm tích số hoặc thừa số." },
  { id: 3, title: "CĐ3: So sánh biểu thức", query: "A ± B [?,<,>] C ± D", link: "/archimedes/lop-1/chuyen-de-3", desc: "So sánh 2 vế logic, định cấu hình độ phức tạp biểu thức." },
  { id: 4, title: "CĐ4: Đặt tính hàng dọc", query: "+ / - có nhớ", link: "/archimedes/lop-1/chuyen-de-4", desc: "Giới hạn số chữ số, ẩn một chữ số bất kì, bắt buộc có/không nhớ." },
  { id: 5, title: "CĐ5: Dãy số chu kỳ", query: "[A, B, C, _]", link: "/archimedes/lop-1/chuyen-de-5", desc: "Tạo dãy số chu kỳ lặp lại, học sinh tìm số thiếu dựa vào tổng chu kỳ." },
  { id: 6, title: "CĐ6: Thử thách Sudoku", query: "Bảng 4x4, 6x6, 9x9", link: "/archimedes/lop-1/chuyen-de-6", desc: "Rèn luyện logic loại trừ với các bảng Sudoku từ dễ đến khó." },
  { id: 7, title: "CĐ7: Xem đồng hồ", query: "Analog & Digital", link: "/archimedes/lop-1/chuyen-de-7", desc: "Học cách đọc giờ đúng, giờ rưỡi và vẽ kim đồng hồ tương ứng." },
    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      <div className="flex flex-col md:flex-row justify-between items-start gap-4">
        ...
        <Button asChild size="lg" className="gap-2 bg-primary font-bold shadow-lg shadow-primary/20">
          <Link href="/archimedes/lop-1/mixer">
             <Library className="size-5" />
             Bộ trộn đề tổng hợp (Mixer) Lớp 1
          </Link>
        </Button>
      </div>
